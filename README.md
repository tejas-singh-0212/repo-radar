...
| [github/spec-kit](https://github.com/github/spec-kit) | GitHub's open-source prompting framework and toolkit for Spec-Driven Development (SDD) to guide AI coding agents with specs, plans, and task guardrails. |
